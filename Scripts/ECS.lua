...
ECS.Relics = {
	...
	{
		name="Oghma Infinium",
		desc="This totem of Hermaeus Mora grants arcane knowledge that will prove to be an anathema to your foes.",
		effect="Cancels someone else's relic on one song",
		charges=1,
		rank=3,
		img="oghmainfiniumicon.png",
		action=function() end
	},
	{
		name="Excalibur",
