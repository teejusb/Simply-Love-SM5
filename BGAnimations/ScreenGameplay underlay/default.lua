...
local t = Def.ActorFrame{
	...
	OnCommand=function(self)
		if (ECS.Mode == "Freeplay" or ECS.Mode == "Warmup") and ThemePrefs.Get("KeyboardFeatures") and PREFSMAN:GetPreference("EventMode") and not GAMESTATE:IsCourseMode() then
...
for player in ivalues(Players) do
	...
	t[#t+1] = LoadActor("./PerPlayer/BreakTimer.lua", player)
